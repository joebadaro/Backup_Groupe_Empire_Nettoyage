...
const UPLOAD_DIR = 'C:/Users/joeba/.gemini/antigravity/brain/4acb5e1b-7cb6-490d-a31c-243fc9df0fb6';
const DEST_DIR = path.join(__dirname, 'public/images/catalog');

// Uploaded files map (based on user input order if possible, or just scan)
const uploadedFiles = [
    'uploaded_image_0_1766529908524.jpg',
    'uploaded_image_1_1766529908524.jpg',
    'uploaded_image_2_1766529908524.jpg',
    'uploaded_image_3_1766529908524.jpg'
];

...
const images = [
    { src: 'uploaded_image_0_1766437814644.jpg', dest: 'hero-slide-4.webp' }, // Carpet living room
    { src: 'uploaded_image_1_1766437814644.jpg', dest: 'hero-slide-5.webp' }, // Team + Vans
    { src: 'uploaded_image_2_1766437814644.jpg', dest: 'hero-slide-6.webp' }  // Van outside
];

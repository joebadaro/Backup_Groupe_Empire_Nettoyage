...
async function processNewLogo() {
    const src = 'C:\\Users\\joeba\\Desktop\\logo officiel\\logo last update 1.png';
    ...
    const basename = 'public/images/logo-last-update-1';
    ...
    console.log("White background completely removed from new logo!");
}

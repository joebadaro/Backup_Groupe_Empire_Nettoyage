 ...
 * Service icons: single source via getEstimationIconHtml() → serviceImagery.ts
 */

import { getEstimationIconHtml } from "./serviceImagery";
  ...
  services: [
    {
      ...
      icon: getEstimationIconHtml("meubles"),
      items: [
        {
          id: "chaise",
          label: {
            fr: "Chaise de cuisine ou chaise équivalente",
            en: "Kitchen Chair or equivalent",
          },
          price: 29.0,
        ...
        },
        {
          ...
          desc: {
            fr: "Sélectionnez le nombre de places assises total",
            en: "Select total number of seats",
          },
          options: [
            {
              val: 3,
    ...
    },
    {
      ...
      icon: getEstimationIconHtml("meubles_cuir"),
      items: [
        {
          id: "cuir_fauteuil",
    ...
    },
    {
      ...
      icon: getEstimationIconHtml("matelas"),
      items: [
        { id: "mat_king", label: { fr: "Matelas King", en: "King Mattress" }, price: 179.0 },
        { id: "mat_queen", label: { fr: "Matelas Queen", en: "Queen Mattress" }, price: 149.0 },
        { id: "mat_double", label: { fr: "Matelas Double", en: "Double Mattress" }, price: 129.0 },
        { id: "mat_simple", label: { fr: "Matelas Simple", en: "Single Mattress" }, price: 99.0 },
      ],
    },
    {
      id: "tapis_mur",
      ...
      icon: getEstimationIconHtml("tapis_mur"),
      items: [
        {
          id: "package_3rooms",
          label: {
            fr: "Forfait: 3 pièces (Max 175pi²/ch)",
            en: "Package: 3 rooms (Max 175sqft/rm)",
          },
          price: 195.0,
          type: "checkbox",
        ...
        },
        {
          ...
          type: "input_qty",
          desc: {
            fr: "75 $ chaque pièce (Maximum 175 pieds carrés chaque)",
            en: "$75 per room (Maximum 175 sq ft each)",
          },
        },
        {
          id: "hallway",
    ...
    },
    {
      ...
      icon: getEstimationIconHtml("tapis"),
      items: [
        {
          id: "rug_synth",
    ...
    },
    {
      ...
      icon: getEstimationIconHtml("ceramique"),
      items: [
        {
          id: "tiles_sqft",
          ...
          forms: {
            totalTitle: {
              fr: "Superficie totale (pieds carrés (pi²)) :",
              en: "Total area (square feet (sqft)):",
            },
            roomTitle: { fr: "Nombre de pièces :", en: "Number of rooms:" },
            instruct: {
              fr: "Indiquez les dimensions pour chaque pièce :",
              en: "Enter dimensions for each room:",
            },
    ...
    },
    {
      ...
      icon: getEstimationIconHtml("escalier"),
      items: [
        {
          id: "marche",
          label: {
            fr: "Combien de marches vous avez à nettoyer ?",
        ...
        },
        {
          id: "palier",
          label: {
            fr: "Combien de paliers vous avez à nettoyer ?",
            en: "How many landings to clean?",
          },
          cartLabel: { fr: "Paliers", en: "Landings" },
          price: 20.0,
          type: "input_qty",
    ...
    },
    {
      ...
      icon: getEstimationIconHtml("tapis_commercial"),
      isQuoteOnly: true,
      longDescription: {
